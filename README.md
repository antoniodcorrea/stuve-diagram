...
- Adds a soaring analysis box (trigger temperature, working band, mixed-layer lapse rate, estimated thermal climb rate against the Tmax-hour profile, cloud base/top, surface T–Td spread, thermal index, CAPE/CIN, lifted/Showalter/K/Total-Totals indices, freezing level, precipitable water, mean wind and shear), a wind hodograph with altitude labels every kilometre, and shades the CAPE area. The freezing level is drawn, and the lifting/convective condensation, free-convection and equilibrium levels (LCL/CCL/LFC/EL) are labelled beside the curves.
